...
//vous pouvez crée et ajouter n'importe quel fichier batch pour l'executer, vous devez en suite l'executer et extraire et reccupéré les informations du fichier batch qui s'affiche dans le fichier text dans le dossier ordres
